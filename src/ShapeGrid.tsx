...
const ShapeGrid: React.FC<ShapeGridProps> = ({
  ...
  const hoveredSquare = useRef<HoveredCell | null>(null);
  const trailCells = useRef<HoveredCell[]>([]);
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      gradient.addColorStop(0, 'rgba(248, 249, 251, 0)');
      gradient.addColorStop(1, 'rgba(248, 249, 251, 1)'); // Fades into background light color (#F8F9FB) at boundaries
